...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            if (Id != 0)
                cli[0].beneficiarios = ConsultarBeneficiarios(Id);
        ...
        /// <summary>
        /// Atualiza os beneficiarios do Cliente
        /// </summary>
        /// <param name="beneficiarios">Objeto de cliente</param>
        internal void AtualizaBeneficiarios(Cliente cli)
        {
            List<Beneficiario> beneficiarios = ConsultarBeneficiarios(cli.Id);

            foreach (var beneficiario in beneficiarios)
            {
                if (cli.beneficiarios.Where(b => b.Id == beneficiario.Id).Count() == 0)
                {
                    List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            foreach (var beneficiario in cli.beneficiarios)
            {
                List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
                ...
                if (beneficiario.Id == 0)
                {
                    ...
                    base.Executar("FI_SP_IncBeneficiarioV1", parametros);
                }
                else
                {
                    parametros.Add(new System.Data.SqlClient.SqlParameter("Id", beneficiario.Id));
        ...
        internal List<Beneficiario> ConsultarBeneficiarios(long idCliente)
        {
            ...
            List<Beneficiario> beneficiarios = ConverterBeneficiario(ds);
